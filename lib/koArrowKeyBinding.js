...
/**
 * A knockout binding for handling arrow key strokes.
 * Captures keydown events on the given element, then passes an object with a 
 * key-dependent property (up|down|left|right === 1) to the a callback.
 * Arrow directions (left/right vs. up/down) can be handled separately, combined or exclusively.
 *
 * Example:
 *   viewModel = {
 *       onArrowKey = (arrow) => {
